...
<head>
    <meta charset="UTF-8">
    <title>TOPE: Baja producto</title>
        ...
        <header id="header">
            ...
            <nav class="main-nav navbar-collapse collapse" id="primary-nav" style="margin-top: -5%;">
                ...
                <ul class="nav nav-pills negrita">
                    <li class="dropdown"><a href="indexGerente.jsp">Inicio</a>
          ...
          <div class="container">
            <div class="heading text-center animate bounceIn informacion"> 
                ...
                <div class="request-a-callback-content">
                   	 	<p>Introduce el producto al que quieres dar de baja<br> 
                   	 		
                   	 	</p>
                </div>   
                <form id="form_datos" name="form_datos" id="form_datos"  action="<%= request.getContextPath() %>/BajaProducto" method="post">
					<div class="request-a-callback-form">
                		<label for="nombre"></label>
                        <!--  <input type="text" name="idCliente" id="idCliente" placeholder="Id cliente" required title="Campo obligatorio">-->
                        <input type="text" name="nombre" id="nombre" placeholder="Nombre del producto" required title="Campo obligatorio">
